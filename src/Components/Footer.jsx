  ...
  return (
    <div className='mt-20'>
        <div className='crd-2  xl:w-[1170px] xl:h-[293px] lg:w-[950] lg:h-[220px] max-md:flex-col max-md:flex  flex justify-center align-middle'>
            <h1 className='max-md:mt-10 max-md:text-center max-sm:text-xl xl:text-5xl lg:text-3xl md:text-2xl text-left text-white m-auto sm:text-xl'>Let’s try our service now!
                <br />
        ...
        <div className='flex text-white md:gap-20 mt-13 text-xl justify-around underline-offset-2 max-md:gap-15 max-md:text-[10px] '>
        ...
        <span className='flex gap-10 items-center'>
          <p className='text-gray-600 mt-5 text-left max-md:text-[8px]'>Copyright © Pranam Shaw</p>
